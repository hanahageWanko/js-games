import type { iGame } from "./@types/main";
import type { iEnemy } from "./@types/enemy";
import type { iFloatingMessage } from "./@types/floatingMessage";
...
class Game implements iGame {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.maxSpeed = 3;
    // 背景画像の設定
    this.background = new Background(this, layerImageNames);
    // プレイヤーのキャラクター
